...
add:
    ...
    mov r1, #98        //moved de pointer naar de 1 na laatste plaats in de buffer
...
convert:
    ...
    add r5, r5, #1    //gaat naar offset
    ldrb r7, [ r5 ]   //sla offset op

    add r5, r5, #1    //gaat naar offset
    ldrb r4, [ r5 ]   //sla length op

    add r5, r5, #1    //gaat naar eerst volgende char  
...
loop2:
    ...
    cmp r4, #0           //kijkt of je klaar bent met de loop
    beq loop
